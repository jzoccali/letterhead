...
ok("logo-left" in js and "stacked-photo" in js and "banner" in js, "new templates missing")
ok("footer" in js and '"card"' in js, "footer/card templates missing")
ok("Choose a template" in html, "template picker missing")
ok("tplDialog" in html, "template dialog missing")
ok("LAYOUTS" in js, "LAYOUTS list missing")
ok("Georgia" in html and "Arial" in html, "web-safe fonts missing")
ok("Palatino" in html and "Calibri" in html, "popular extra fonts missing")
ok("nameSize" in html and "bodySize" in html, "size controls missing")
ok("extra1Url" in html and "extra2Url" in html, "extra link fields missing")
ok("joeyzoccali.com/diagnostic" in html, "diagnostic placeholder missing")
ok("rankandkeep.com/free-report" in html, "rankandkeep placeholder missing")
